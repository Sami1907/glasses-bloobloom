<template>
<GlassRendererSunMen  :glasses="glasses" :key="glasses" v-if="glasses.length" ref="scrollComponent" @glassesx="test"  />
...
import GlassRendererSunMen from "../components/GlassRendererSunMen.vue"
import getGlassesSunMen from "../composables/getGlassesSunMen";
import { ref, onMounted, onUnmounted,defineExpose, reactive} from "vue";


    let {glasses,load}=getGlassesSunMen(27,1);
     load();
